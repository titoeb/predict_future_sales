...
params = {'colsample_bytree': 0.5, 'eta': 0.025, 'gamma': 0.9, 'max_depth': 11, 'min_child_weight': 5.0, 'subsample': 1.0,  'seed': 1993}
...
xgb.fit(X_train, y_train, eval_metric="rmse", eval_set=[(X_train, y_train), (X_val, y_val)], verbose=True, early_stopping_rounds=10)
